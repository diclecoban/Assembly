module alu (
    ...
    mux_8to1 mux (
        .a(sum), // I have changed something.
        .b(diff), 
        .c(and_out), // it works fine
        .d(or_out), // it works fine
        .e(xor_out), // it works fine
        .f(nor_out), // it doesn't work correctly. I have changed it into nor_gate file
        .g(32'b0), //Not used
        .h(32'b0), //Not used 
        .sel(alu_op),
        .out(result)
